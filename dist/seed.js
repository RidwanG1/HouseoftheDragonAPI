...
var getCharacterPageNames = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "https://gameofthrones.fandom.com/wiki/Category:HotD/Living_individuals";
...
var getCharacterInfo = function (characterName) { return __awaiter(void 0, void 0, void 0, function () {
    var url, data, $, name, allegiance, image, characterInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = "https://gameofthrones.fandom.com/wiki/" + characterName;
                return [4 /*yield*/, axios_1.default.get(url)];
            case 1:
                data = (_a.sent()).data;
                $ = cheerio_1.default.load(data);
                name = $('h2[data-source="name"]').text();
                allegiance = $('div[data-source="Allegiance"] > div.pi-data-value.pi-font').text();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                characterInfoPromises = characterPageNames.map(function (characterName) { return getCharacterInfo(characterName); });
                return [4 /*yield*/, Promise.all(characterInfoPromises)];
            case 2:
                characters = _a.sent();
                values = characters.map(function (character, i) { return [i, character.name, character.allegiance, character.image]; });
                sql = "INSERT INTO Characters (id, name, allegiance, image) VALUES ?";
